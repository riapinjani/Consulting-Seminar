...
```{r}
write.csv(queens2011, 'queens2011.csv')
write.csv(manhattan2011, 'manhattan2011.csv')
write.csv(bronx2011, 'bronx2011.csv')
write.csv(brooklyn2011, 'brooklyn2011.csv')
write.csv(statenisland2011, 'statenisland2011.csv')

write.csv(queens2015, 'queens2015.csv')
write.csv(manhattan2015, 'manhattan2015.csv')
write.csv(bronx2015, 'bronx2015.csv')
write.csv(brooklyn2015, 'brooklyn2015.csv')
write.csv(statenisland2015, 'statenisland2015.csv')
